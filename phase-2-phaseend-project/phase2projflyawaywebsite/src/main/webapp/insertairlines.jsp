...
<head>
<meta charset="UTF-8">
<title>Insert Airlines</title>
</head>
<body style="background-color:rgb(135, 206, 235);">
<center>
<h1>WELCOME TO FLYAWAY</h1></center>
<center>
<form action = "insertairlineservlet" method = "post" style = "margin: auto; width: 220px;">  
        <div class="container"> 
        <label>AIRLINES ID : </label>   
            <input type="text" placeholder="Enter Airlines ID" name="aid" >  <br></br>    
            <label>AIRLINES NAME : </label>   
            <input type="text" placeholder="Enter Airlines Name" name="airlines" >  <br></br>  
            <button type="submit">Add AIRLINES</button>   
        </div>   
    </form>  
   </center>
   <br></br>
